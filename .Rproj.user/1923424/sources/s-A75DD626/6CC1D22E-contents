...
paste(x, y, sep = ";", collapse = "%")   # collapse skleja caly tekst w jeden
#bardzo prydaten do zapytan np sql
...
t[-1]  #inna forma usuwania danych po indexie
...
#dimnames nazywamy wiersze i kolumny
m1
